...
import { DelOrdersRequest, GetOrdersRequest } from "@/redux-saga/action/orderAction";
...
export default function OrdersSaga() {
  ...
  return (
    <div>
      <Layout>
        {displayEdit ? (
          <OrdersEdit refresh={refresh} setDisplay={setDisplayEdit} id={id} setRefresh={setRefresh} />
        ) : display ? (
          <OrdersCreate setRefresh={setRefresh} setDisplay={setDisplay} />
        ) : (
          <div>
            <div className="mb-0">
              <button
                              ...
                              return (
                                <>
                                  <tr className="bg-white border-b transition duration-300 ease-in-out hover:bg-gray-100">
                                    ...
                                    <td className="text-sm text-black-900 font-dark px-6 py-4 whitespace-nowrap">{cust.totalproduct}</td>
                                    <td className="text-sm text-black-900 font-dark px-6 py-4 whitespace-nowrap">{cust.totalprice}</td>
